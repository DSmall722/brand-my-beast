...
/**
 * Slice 12.42 — operator health: last Drizzle migration name.
 */
  ...
  return (
    <>
      ...
      >
        ...
        <h1>Health</h1>
        <p className="section-lead">
          Last Drizzle migration on disk. Floor {formatUsd(FLOOR_USD)}. Buyout{" "}
          {formatUsd(GOAL_USD)}.
        </p>
        ...
        <dl className="auth-dl" data-testid="operator-health-dl">
          <div>
            <dt>DB ping</dt>
            <dd data-testid="operator-health-db">{status.db.label}</dd>
          </div>
          <div>
