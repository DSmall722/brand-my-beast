...
/**
 * QA 1047PM privacy rewrite, plus the approved Terms of Use from PR #434.
 * Footer links both. Back to the board is a button.
 */
test.describe("slice 7.9: privacy policy and approved terms", () => {
