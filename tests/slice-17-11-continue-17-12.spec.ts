...
test.describe("slice 17.11: continue 17.12; Wave 15 still human", () => {
  ...
  test("stop doc says continue 17.12 and Wave 15 still needs a human", () => {
    const doc = readFileSync(DOC, "utf8");
    expect(doc).toContain("17.11");
