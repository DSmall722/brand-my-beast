...
/**
 * Slice 20.5 — at pledged $0 do not print Short of buyout $120,000
 * next to Buyout $120,000. CLOSE_AT null. No Stripe. H1 unchanged.
 */

const ROOT = process.cwd();
const LOCKED_H1 = "Advertise your brand on the truck that people already photograph";

test.describe("slice 20.5: hide short of buyout at pledged $0", () => {
  ...
  test("money block at $0 keeps Buyout and drops Short of buyout", async ({
    page,
  }) => {
    await page.goto("/");
