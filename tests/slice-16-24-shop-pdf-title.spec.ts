...
/**
 * Slice 16.24 — shop PDF title is `Seat 03 — Driver doors`, not only the slug.
 * FEATURES.md stays off /. CLOSE_AT null. No Stripe.
 */

const PANEL_ID = "driver-door" as const;
const TITLE = "Seat 03 — Driver doors";
...
test.describe("slice 16.24: shop PDF title is numbered seat", () => {
  ...
  test("title is Seat 03 — Driver doors, not the slug", async () => {
