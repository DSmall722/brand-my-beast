...
The board shows BrandMyBeast, raised `$0`, floor `$58,000` (order + wrap), buyout `$120,000` (buy + etch), and an unset close date.
...
- `board-close` states the close date is unset.
...
- **Read close copy.** Assert `close-copy` contains `Close date unset`.
