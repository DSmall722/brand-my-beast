...
**Now:** 17.11 After 17.10 continue 17.12. Wave 15 is still Stripe and needs a human message.
**Last merged:** 17.10 Homepage `.panel-face` is not an empty black rectangle.
...
- [x] 17.10 Homepage `.panel-face` is not an empty black rectangle.
