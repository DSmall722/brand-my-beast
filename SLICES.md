...
**Now:** 10.3 Etch toggle disabled unless pledged >= $120,000. Playwright on the seat.
**Last merged:** 10.2 (#137 Seat compositor renders the standing brand, not only a typed preview).
