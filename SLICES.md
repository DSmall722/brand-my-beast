...
**Now:** 13.27 Etch art rejected if linter fails; wrap art may still list.
**Last merged:** 13.26 (#TBD art size cap documented in RULES.md).
...
- [x] 13.26 Art size cap documented (max bytes in RULES.md). (#TBD)
