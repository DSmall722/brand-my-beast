...
**Now:** 14.32 Playwright: `SEATS_OPEN=false` → intent POST 403, waitlist still 201.
**Last merged:** 14.31 Standing brand change after approve is forbidden.
...
- [x] 14.31 Standing brand change after approve is forbidden.
