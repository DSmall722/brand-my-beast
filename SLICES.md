...
**Now:** 14.43 Playwright journey: waitlist → sign-in (test) → hood intent → approve → `/account/wins`.
**Last merged:** 14.42 Counsel export ZIP of CONTRACT + standing table. No emails in the ZIP.
...
- [x] 14.42 Counsel export ZIP of CONTRACT + standing table. No emails in the ZIP.
