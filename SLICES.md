...
**Now:** 14.31 Standing brand change after approve is forbidden.
**Last merged:** 14.30 Operator note required when forcing a withdraw of an approved seat.
...
- [x] 14.30 Operator note required when forcing a withdraw of an approved seat.
