...
**Now:** 19.3 Seat lead: if no holder, do not print “Current standing $2,500”.
**Last merged:** 19.2 Remove HometownLaneTags from public seats.
...
- [x] 19.2 Remove `HometownLaneTags` from public seats. No SC / Charlotte / Atlanta / Panhandle on `/panels/*`. Playwright those strings absent.
