...
**Now:** 13.38 Terms stub adds “intent is not a charge.”
**Last merged:** 13.37 (#PR robots.txt excludes /account /signin /operator).
...
- [x] 13.37 `robots.txt` still excludes `/account`, `/signin`, `/operator`. (#PR)
