...
**Now:** 14.41 Maintenance flag: `/` stays up, intent POST returns “not taking marks.”
**Last merged:** 14.40 `List-Unsubscribe` header on waitlist mail.
...
- [x] 14.40 `List-Unsubscribe` header on waitlist mail.
