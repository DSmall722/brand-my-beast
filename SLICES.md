...
**Now:** 11.4 Playwright: 50 unique waitlist inserts in memory mode, no 500s.
**Last merged:** 11.3 (verify-brandmybeast feature map Waves 7–10).
...
- [x] 11.3 verify-brandmybeast feature map covers Waves 7–10.
