...
**Now:** 14.4 README one-pager: what the repo is, what it is not.
**Last merged:** 14.3 (#PENDING PROCESS Now + live URL not a gate).
...
- [x] 14.3 PROCESS.md: Now = first unchecked SLICES box; live URL is not a gate. (#PENDING)
