...
**Now:** 11.10 BLOCKED — skip note if Vercel hold still on; else redeploy note only.
**Last merged:** 11.9 (vercel.json stays main-only).
...
- [x] 11.9 `vercel.json` stays main-only. Do not add preview deploys or extra projects.
