...
**Now:** 14.12 `/account` nav has no Cabin plaque while the truck does not exist.
**Last merged:** 14.11 (TRUCK_EXISTS=false must not import plaque / sighting / circuit / Season 2).
...
- [x] 14.11 `TRUCK_EXISTS=false` must not import plaque / sighting / circuit / Season 2 modules.
