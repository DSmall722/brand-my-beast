...
**Now:** 13.3 CAMPAIGN.md links `CONTRACT.md` for wreck text. Money table stays $58,000 / $120,000.
**Last merged:** 13.2 (#209 ARCHITECTURE.md Postgres + Blob + Resend mock; no Stripe box).
