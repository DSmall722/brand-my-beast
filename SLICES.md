...
**Now:** 14.27 Proxy max ignored after the bidder withdraws.
**Last merged:** 14.26 (#284 Failed-winner offer cannot target a banned trade).
...
- [x] 14.26 Failed-winner offer cannot target a banned trade.
