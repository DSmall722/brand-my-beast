...
**Now:** 16.34 `robots.txt` comment: production may be stale while Vercel hold is on. No app behavior change.
**Last merged:** 16.33 OG image for `/panels/[id]` includes the number + name.
