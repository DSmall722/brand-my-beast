...
**Now:** 14.30 Operator note required when forcing a withdraw of an approved seat.
**Last merged:** 14.29 Whole-truck pending blocks new single-panel intents on those seats until decided.
...
- [x] 14.29 Whole-truck pending blocks new single-panel intents on those seats until decided.
