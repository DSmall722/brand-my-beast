...
**Now:** 7.5 `/operator/waitlist` lists waitlist signups.
**Last merged:** 7.4 (#TBD leftover memory stores banned in Production.)
...
- [x] 7.4 Delete or Postgres-back leftover memory stores (plaque, sighting, circuit, content-rights). Production has no in-memory store. Same rule as 6.7. (#TBD)
