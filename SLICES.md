...
**Now:** 14.34 Next-minimum display uses integer dollars only.
**Last merged:** 14.33 Deposit preview uses the same helper as 12.5.
...
- [x] 14.33 Deposit preview uses the same helper as 12.5.
