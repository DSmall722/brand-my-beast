...
**Now:** 13.30 Remove Cabin plaque form from any authenticated nav while `TRUCK_EXISTS` is false.
**Last merged:** 13.29 (#TBD Immortal vault certificate markdown template; blank issued date).
...
- [x] 13.29 Certificate template exists as markdown only. No issued date until etch exists. (#TBD)
