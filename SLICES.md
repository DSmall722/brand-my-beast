...
**Now:** 0.4 Playwright waitlist contract.
**Last merged:** 0.3 (#pending homepage copy audit)
...
- [x] 0.3 Homepage copy audit: no process-memo voice, no invented miles/scans/city hours. (#pending)
