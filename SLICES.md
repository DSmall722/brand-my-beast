...
**Now:** 16.4 Playwright 390px: numbers 1, 3, 5, 9 visible and not clipped by the wordmark.
**Last merged:** 16.3 Number map legend under the hero: `1 Hood … 12 Rear fascia` from PANELS only.
