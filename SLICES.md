...
- [x] 8.10 Boot assert: `AUTH_ENABLE_TEST_LOGIN` cannot be on when `VERCEL_ENV=production`. (#125)
...
- [x] 9.5 Hide whole-truck control when pledged >= $120,000. Unit + Playwright lock. (#130)
