...
**Now:** 17.5 `PUBLIC_COPY.signIn.notOpenYet` + matching PUBLIC_COPY.md line.
**Last merged:** 17.4 `/signin` live empty state + waitlist link. No env key names in public copy.
