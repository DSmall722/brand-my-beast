...
**Now:** 14.21 `/llms.txt` with PUBLIC_COPY facts only.
**Last merged:** 14.20 (press kit: avi, header, stainless still, fact sheet).
...
- [x] 14.20 Press kit folder: avi, header, one stainless still, one-paragraph fact sheet. No wrap-as-delivered.
