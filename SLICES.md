...
**Now:** 14.3 PROCESS.md: Now = first unchecked SLICES box; live URL is not a gate.
**Last merged:** 14.2 (#PENDING ARCHITECTURE Stripe not wired).
...
- [x] 14.2 ARCHITECTURE.md: Postgres + Blob + Resend mock. Stripe box = “not wired.” (#PENDING)
