...
**Now:** 8.6 Shop PDF builder for an approved seat (panel, brand, wrap vs etch, art). No Imagine API call.
**Last merged:** 8.5 (#120 Artwork in Blob storage — no data-URL column).
