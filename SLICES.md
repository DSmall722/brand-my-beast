...
**Now:** 13.33 Rate-limit operator approve/reject.
**Last merged:** 13.32 (#TBD all-panels standing needs whole-truck path).
...
- [x] 13.32 Same user cannot hold standing on all 12 panels unless whole-truck path. (#TBD)
