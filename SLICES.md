...
**Now:** 19.4 Hide Day/Night/Wet/Dirty and etch preview toggles on public seats while `TRUCK_EXISTS` is false.
**Last merged:** 19.3 Seat lead: if no holder, do not print “Current standing $2,500”.
...
- [x] 19.3 Seat lead: if no holder, do not print “Current standing $2,500”. Opening price only. Standing line only when a mark exists.
