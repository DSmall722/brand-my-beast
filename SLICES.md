...
**Now:** 20.2 Public seat: hide Sign in to download a seat PNG while SEATS_OPEN is false.
**Last merged:** 20.1 Homepage header: hide Sign in while sign-in is closed.
...
- [x] 20.1 Homepage header: hide **Sign in** while sign-in is closed. **Join the list** only.
