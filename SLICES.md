...
**Now:** 19.11 Document title / 404 title use BrandMyBeast + locked idea.
**Last merged:** 19.10 Homepage vault while pledged is $0: “No marks yet”.
...
- [x] 19.10 Homepage vault while pledged is $0: “No marks yet” (or PUBLIC_COPY equivalent). Do not read like an empty auction.
