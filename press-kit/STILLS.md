...
| `truck-view-driver.jpg` | Underground garage driver-side profile. Nose left. Pre-cropped full side, TRACE AID lime flat, 2048×1360. | Supplied board bake. Seats 4–6 labeled in the pixels. |
...
Front, rear, and driver board JPEGs are 2048×1360 TRACE AID flats. The passenger plate is the plaza bake (1728×1152). The driver plate is the pre-cropped full side — the board shows it at normal framing, with no extra zoom.
