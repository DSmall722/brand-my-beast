...
7. **P2** soft auction — Auth.js + panel intent UI + approvals + durable ledger + waitlist→intent CTA are in. Verify skill covers panel intent. Still no capture. **P3** only after LLC + terms + wreck clause.
